...
// FIX (same integration issue as hardCapService/addressService, applied
// proactively here): previously only exported loose functions. Adding a
// named service-object export for projects that import it the
// class-instance way (`genericValidator.evaluateAllFields(...)`), plus a
// default export, so whichever import convention your project uses will
// resolve.
