...
onSortChanged(): void {
  ...
  //The date is ISO format 2026-07-24T15:29:10.454Z. Update formatToDisplayDate to handle both formats:

  formatToDisplayDate(dateStr: any): string {
    if (!dateStr || typeof dateStr !== 'string') return '';
    
    // ISO format: 2026-07-24T15:29:10.454Z
