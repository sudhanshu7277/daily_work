...
import React, {
  ...
  export const PaymentParent: FC = () => {
    ...
    // Common Modal State for All Modes
    ...
    // =========================================================================
    // 2. CHECKER MODE STATE & HANDLERS (UNCOMMENT SECTION IN JSX TO TEST)
    // =========================================================================
    ...
    // Sample data arriving from authorization queue for Checker review
    ...
    // =========================================================================
    // 3. REPAIR MODE STATE & HANDLERS (UNCOMMENT SECTION IN JSX TO TEST)
    // =========================================================================
    ...
    // Sample rejected data arriving for Repair correction
    ...
    return (
      <div className="sample-container">
        ...
        {/* ===================================================================== */}
        {/* 2. CHECKER MODE VIEW (UNCOMMENT BELOW TO TEST CHECKER MODE)           */}
        {/* ===================================================================== */}
        {/*
        ...
        */}
        ...
        {/* ===================================================================== */}
        {/* 3. REPAIR MODE VIEW (UNCOMMENT BELOW TO TEST REPAIR MODE)             */}
        {/* ===================================================================== */}
        {/*
