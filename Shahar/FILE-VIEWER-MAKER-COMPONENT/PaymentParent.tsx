import React, {
  ...
  // Checker / Repair Config: Only 3 fields enabled, rest disabled
  ...
  export const PaymentParent: FC<PaymentParentProps> = ({
    ...
    const makerPaymentInput: PaymentComponentInput = useMemo(() => {
      ...
      const mergedModel: Pain001Model = {
        ...
        painPaymentMethodType: initialData?.painPaymentMethodType ? initialData.painPaymentMethodType : 'CBT',
    ...
    // =========================================================================
    // 2. CHECKER MODE (With Dynamic Defaults & Mock Fallback API)
    // =========================================================================
    ...
    // Complete pre-filled fallback for all required ISO 20022 fields using ternary operators
    const checkerDynamicModel: Pain001Model = useMemo(() => {
      ...
      return {
        ...
        instructedAmount: typeof initialData?.instructedAmount === 'number' ? initialData.instructedAmount : 10000,
    ...
    // Checker Decision Action (Calls real endpoint with safe simulated fallback)
    const handleCheckerDecision = async (action: 'Approved' | 'Rejected') => {
      ...
      try {
        ...
        // Placeholder Fallback: Allows testing without being blocked by missing backend API
    ...
    // =========================================================================
    // 3. REPAIR MODE (With Dynamic Defaults & Mock Fallback API)
    // =========================================================================
    ...
    // Repair Resubmit Action (Calls real endpoint with safe simulated fallback)
