...
describe('FilterPresetBar', () => {
  ...
  it('saves a new view with serialized current filters, then reloads', async () => {
    ...
    // Clear call history prior to saving to isolate reload call verification
    mockListFilterPrefs.mockClear();
  ...
  it('disables Delete until a pref is selected, then deletes and reloads', async () => {
    ...
    // Clear call history prior to deletion to isolate reload call verification
    mockListFilterPrefs.mockClear();
